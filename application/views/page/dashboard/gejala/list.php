<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Menu Gejala</h1>
  <a href="#" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#tambah">Tambah Gejala</a>
</div>
<div class="row">
	<div class="col-sm-12">
	      	...
	      	<div class="modal-body">
	        	<ul class="list-group">
	        		<form action="<?php echo base_url('dashboard/gejala/tambah'); ?>" method="POST">
	        			...
	        			<div class="form-group">
	        				<label>Gejala</label>
	        				<textarea name="gejala" class="form-control">
	        				</textarea>
	        			</div>
